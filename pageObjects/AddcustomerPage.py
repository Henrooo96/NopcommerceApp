...
class AddCustomer:
    ...
    def clickOnCustomersMenuItem(self):
        self.driver.find_element_by_xpath(self.lnkCustomers_menuitem_xpath).clicl()
    ...
    def setCustomerRoles(self, role):
        ...
        if role == 'Registered':
            ...
            # Here user can be Registered(or) Guest, only me
            time.sleep(3)
            self.driver.find_element_by_xpath().click("//[@id='SelectedCustomerRoleIds_taglist']/li/span[2]").click()
